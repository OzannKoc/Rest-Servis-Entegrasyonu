package com.ogrenci.OgrenciBilgiSistemiApp.entity;
...
public class Ogrenci {
	@Id
	@SequenceGenerator(name = "ogrenci-numarator",sequenceName = "OBS_SEQ",allocationSize = 1)
	@GeneratedValue (strategy = GenerationType.SEQUENCE,generator = "ogrenci-numarator")
	private Integer id ;
